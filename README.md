...
- [「IslandFlight」ポートフォリオ](#islandflightポートフォリオ)
  ...
  - [6.学習方法・AIの活用](#6学習方法aiの活用)
    - [6.1 問題から考え始める](#61-問題から考え始める)
    - [6.2 AIを使った学習](#62-aiを使った学習)
    - [6.3 実際の学習過程](#63-実際の学習過程)
...
一方で、物理モデルとして実装したことにより、
挙動をブラックボックス化せず、
力やモーメントの関係として説明できる構造を持たせることができました。
見た目の派手さには直結しませんでしたが、
「なぜその挙動になるのか」を因果関係として理解できる状態を作れたことは、
設計理解という面で大きな収穫でした。
...
ここでは、普段どのように勉強しているかと、その中でAIをどのように使っているかについて書きます。

### 6.1 問題から考え始める

新しいことを学ぶときは、最初から完成された公式や定義を覚えるのではなく、まず「この問題はどうすれば解けるのか」を自分で考えます。
考えている中で、
「今の考え方には何が足りないのか」
「どこから分からなくなっているのか」
「自分の直感と実際の理屈は、どこでずれているのか」
「なぜ、この考え方や定義が必要なのか」
といった疑問が出てきます。
最初から疑問をうまく言葉にできるとは限らないので、考えながら一つずつ細かく分け、自分が何につまずいているのかを探していきます。
公式や解説を見ることもありますが、そのまま答えとして覚えるのではなく、自分で考えるためのヒントとして使います。
式を使えるようになるだけでなく、なぜその形になるのか、何を解決するために必要なのかまで考え、最後は自分でも「だからこの式になるのか」と納得できるところまで理解することを目指しています。

### 6.2 AIを使った学習

AIは、自分の考えを言葉にするための壁打ち相手として使っています。
疑問がまだまとまっていないときでも、今考えていることや、自分なりの仮説、どこに違和感があるのかをそのまま伝えます。
実際に言葉にしてみると、自分の考えが途中で飛んでいたり、言葉の意味を曖昧なまま使っていたりすることに気づけます。また、AIの説明を読んで新しい疑問が出てきた場合は、そこからさらに細かく質問していきます。
AIの回答をそのまま自分の答えにするのではなく、自分でもう一度考えるためのヒントとして使っています。
ある程度自分の中で理解できた後は、教科書や専門書、公式ドキュメントなどを読み、自分が考えてきた内容に間違いや抜けがないかを確認します。

### 6.3 実際の学習過程

以下の画像は、実際にAIとやり取りしながら勉強した内容の一部です。

普段は数学だけでなく、プログラミングや物理、設計など、さまざまな分野の学習にAIを使っています。今回は、その中でも疑問を分けながら考えていく過程が伝わりやすいものとして、数学について学習した例を掲載しています。

<div style="display: flex; gap: 16px;">
  <img src="Images/AIStudyTopics.png" width="50%">
  <img src="Images/AIStudyDialogue.png" width="60%">
  </div>
...
- フーリエ・ラプラス変換
<a href=https://chatgpt.com/g/g-p-6a0d0c8f8c248191a078d117b41f73fe-hurierahurasubian-huan/project><https://chatgpt.com/g/g-p-6a0d0c8f8c248191a078d117b41f73fe-hurierahurasubian-huan/project/>

- 代数：
<a href=https://chatgpt.com/g/g-p-691fb9798a2c819183e4c7a0489c3306-dai-shu/project><https://chatgpt.com/g/g-p-691fb9798a2c819183e4c7a0489c3306-dai-shu/project>

- 虚数の疑問：
<a href=https://chatgpt.com/g/g-p-6a16614d07588191ad3cdbbed5944973-xu-shu-noyi-wen/project><https://chatgpt.com/g/g-p-6a16614d07588191ad3cdbbed5944973-xu-shu-noyi-wen/project>

- イプシロンデルタ周りの疑問：
<a href=https://chatgpt.com/g/g-p-69d521456e348191ac5d83bb429669ff-ihusironterutazhou-rinoyi-wen/project><https://chatgpt.com/g/g-p-69d521456e348191ac5d83bb429669ff-ihusironterutazhou-rinoyi-wen/project>
